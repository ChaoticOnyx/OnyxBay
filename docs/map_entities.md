...
Считывает предметы из одного предмета и записывает в другой.
...
- `ev_dest_tag` - тэг или референс предмета на координатор которого нужно телепортировать.
...
- `ev_signal_source` - тэг или референс на объект чей сигнал нужно отслеживать.

...
/mob/living/simple_animal/Destroy()
	// когда моба удаляют с карты нам нужно разорвать циклическую ссылку.
	mob_ai.holder = null // Разрываем связь между mob_ai и удаляемым мобом
	QDEL_NULL(mob_ai)	// Убиваем ссылку на mob_ai.

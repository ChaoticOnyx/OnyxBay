...
#define SPECIES_NOT_CHOOSEABLE		0x8		// Species cannot be selected in chargen in chargen in the usual way
#define SPECIES_NO_FBP_CONSTRUCTION 0x10    // FBP of this species can't be made in-game.
#define SPECIES_NO_FBP_CHARGEN      0x20	// FBP of this species can't be selected at chargen.
#define SPECIES_NO_LACE             0x40	// This species can't have a neural lace.
#define SPECIES_IS_FBP				0x80	// This species is full synthetic

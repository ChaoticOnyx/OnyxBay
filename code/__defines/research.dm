#define DECONSTRUCT_COEFF1 0.5
#define DECONSTRUCT_COEFF2 0.3
#define DECONSTRUCT_COEFF3 0.2

#define DECONSTRUCT_POINTS_COEFF_MUL 100
#define DECONSTRUCT_POINTS_COEFF_POW 2

#define RESEARCH_REQUIREMENTS_COEFF_MUL 100
#define RESEARCH_REQUIREMENTS_COEFF_POW 2

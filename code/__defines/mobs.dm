...
#define INCAPACITATION_WEAKENED 16 //needs a better name - represents being knocked down BUT still conscious.
#define INCAPACITATION_RESTING 32
#define INCAPACITATION_KNOCKOUT 64

#define INCAPACITATION_FORCELYING (INCAPACITATION_RESTING|INCAPACITATION_WEAKENED)

...
#define SIGNAL_ITEM_REQUESTING_CONTEXT_FOR_TARGET "item_requesting_context_for_target"
...
/// that map to the action as text.
/// If you mutate the list in this signal, you must return CONTEXTUAL_SCREENTIP_SET.
#define SIGNAL_ATOM_REQUESTING_CONTEXT_FROM_ITEM "atom_requesting_context_from_item"

...
/proc/readglobal(which)
	switch(which)
		...
		if("bioprinter_categories")
			return global.bioprinter_categories;
		if("bioprinter_recipes")
			return global.bioprinter_recipes;
		if("base_miss_chance")
		...
		if("default_body_build")
			return global.default_body_build;
		...
		if("trait_categories")
			return global.trait_categories;
		if("trait_datums")
			return global.trait_datums;
		if("trait_type_to_ref")
...
/proc/writeglobal(which, newval)
	switch(which)
		...
		if("bioprinter_categories")
			global.bioprinter_categories=newval;
		if("bioprinter_recipes")
			global.bioprinter_recipes=newval;
		if("base_miss_chance")
		...
		if("default_body_build")
			global.default_body_build=newval;
		if("default_material_composition")
		...
		if("trait_categories")
			global.trait_categories=newval;
		if("trait_datums")
			global.trait_datums=newval;
		if("trait_type_to_ref")

...
/proc/cp1251toutf8(text)
	text = replacetext_char(text, "�", "а")	
	text = replacetext_char(text, "�", "б")	
	text = replacetext_char(text, "�", "в")	
	text = replacetext_char(text, "�", "г")	
	text = replacetext_char(text, "�", "д")	
	text = replacetext_char(text, "�", "е")	
	text = replacetext_char(text, "�", "ё")	
	text = replacetext_char(text, "�", "ж")	
	text = replacetext_char(text, "�", "з")	
	text = replacetext_char(text, "�", "и")	
	text = replacetext_char(text, "�", "й")	
	text = replacetext_char(text, "�", "к")	
	text = replacetext_char(text, "�", "л")	
	text = replacetext_char(text, "�", "м")	
	text = replacetext_char(text, "�", "н")	
	text = replacetext_char(text, "�", "о")	
	text = replacetext_char(text, "�", "п")	
	text = replacetext_char(text, "�", "р")	
	text = replacetext_char(text, "�", "с")	
	text = replacetext_char(text, "�", "т")	
	text = replacetext_char(text, "�", "у")	
	text = replacetext_char(text, "�", "ф")	
	text = replacetext_char(text, "�", "х")	
	text = replacetext_char(text, "�", "ц")	
	text = replacetext_char(text, "�", "ч")	
	text = replacetext_char(text, "�", "ш")	
	text = replacetext_char(text, "�", "щ")	
	text = replacetext_char(text, "�", "ъ")	
	text = replacetext_char(text, "�", "ы")	
	text = replacetext_char(text, "�", "ь")	
	text = replacetext_char(text, "�", "э")	
	text = replacetext_char(text, "�", "ю")	
	text = replacetext_char(text, "�", "я")	
	text = replacetext_char(text, "�", "А")	
	text = replacetext_char(text, "�", "Б")	
	text = replacetext_char(text, "�", "В")	
	text = replacetext_char(text, "�", "Г")	

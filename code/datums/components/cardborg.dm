/datum/component/cardborg/Initialize(...)
	...
	A.register_signal(parent, SIGNAL_ITEM_EQUIPPED, nameof(/decl/appearance_handler/cardborg.proc/item_equipped))
	A.register_signal(parent, SIGNAL_ITEM_UNEQUIPPED, nameof(/decl/appearance_handler/cardborg.proc/item_removed))

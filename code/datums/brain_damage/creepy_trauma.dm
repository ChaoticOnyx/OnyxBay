...
/datum/brain_trauma/special/obsessed/on_gain()
	...
	register_signal(obsession, SIGNAL_MOB_EYECONTACT, .proc/stare)
	..()
	//antag stuff//
	antagonist.forge_objectives(obsession.mind)
	antagonist.greet()
	register_signal(owner, SIGNAL_CARBON_HELPED, .proc/on_hug)
...
/datum/brain_trauma/special/obsessed/on_lose()
	...
	if(obsession)
		unregister_signal(obsession, SIGNAL_MOB_EYECONTACT)
...
/// Singal proc for [SIGNAL_CARBON_HELPED], when our obsessed helps (hugs) our obsession, increases hug count
...
/datum/brain_trauma/special/obsessed/proc/stare(datum/source, mob/living/examining_mob, triggering_examiner)
	...
	return SIGNAL_BLOCK_EYECONTACT

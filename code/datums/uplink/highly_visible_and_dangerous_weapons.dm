...
/datum/uplink_item/item/visible_weapons/submachinegun
	name = "Submachine Gun"
	item_cost = 52
	antag_costs = list(MODE_SYNDICATE = 20)
...
/datum/uplink_item/item/visible_weapons/machine_pistol
	name = "Machine Pistol"
	item_cost = 45
	antag_costs = list(MODE_SYNDICATE = 10)
...
/datum/uplink_item/item/visible_weapons/pulsecarbine
	name = "Pulse Carbine"
	item_cost = 88
	antag_costs = list(MODE_SYNDICATE = 30)

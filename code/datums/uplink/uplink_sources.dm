...
/decl/uplink_source/pda/setup_uplink_source(var/mob/M, var/amount)
	...
	to_chat(M, "<span class='notice'>A portable object teleportation relay has been installed in your [P.name]. Simply enter the code \"[pda_pass]\" in your PayNOLOG program to unlock its hidden features.</span>")

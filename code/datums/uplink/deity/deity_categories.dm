/datum/uplink_category/deity_ability_general //Generic abilities.
	name = "General Ability Boons"

/datum/uplink_category/deity_unlocks //Basically research new paths to take.
	name = "Potentials"

...
/datum/event2/solar_storm/think()
	radiate()

	set_next_think(world.time + 2 SECONDS)

/datum/event2/solar_storm/proc/radiate()
...
/datum/event2/solar_storm/proc/end()

/datum/trader/ship/pet_shop
	...
	speech = list(
		...
		TRADER_FOUND_UNWANTED     = "I want only metroid extracts. I don't need food or shiny things. I'm looking for specific ones at that. Ones I already have the lab and reagents for.",
		TRADER_NOT_ENOUGH         = "I'd give you the animal for free, but I need the money to feed the others. So you must pay in full.",
		TRADER_HOW_MUCH           = "This is a fine specimen. I believe it will cost you VALUE credits.",
		TRADER_WHAT_WANT          = "I currently need those metroid extracts and seeds:",
...
/datum/trader/ship/prank_shop
	...
	speech = list(
		...
		TRADER_HOW_MUCH           = "We believe that is worth VALUE credits.",
	...
	possible_trading_items = list(/obj/item/clothing/mask/gas/clown_hat 					= TRADER_THIS_TYPE,
								...
								/obj/item/reagent_containers/food/baguette 					= TRADER_THIS_TYPE,
								...
								/obj/item/reagent_containers/spray/hair_grower 				= TRADER_THIS_TYPE
								)
...
/datum/trader/ship/replica_shop
	...
	speech = list(
		...
		TRADER_NO_BLACKLISTED     = "Nay, we accept only the credits. Or sovereigns of the king's mint, of course.",
		TRADER_NOT_ENOUGH         = "Alas, traveler, my fine wares cost more than that.",
		TRADER_HOW_MUCH           = "For VALUE credits, I can part with this finest of goods.",

/datum/trader/ship/pizzaria
	...
	speech = list(
		...
		TRADER_HOW_MUCH           = "That pizza will cost you VALUE credits.",
...
/datum/trader/ship/chinese
	...
	speech = list(
		...
		TRADER_HOW_MUCH           = "I give you ITEM, for VALUE credits. No more, no less.",
...
/datum/trader/ship/grocery
	...
	speech = list(
		...
		TRADER_HOW_MUCH           = "Sir, that'll cost you VALUE credits. Will that be all?",
...
/datum/trader/ship/bakery
	...
	speech = list(
		...
		TRADER_HOW_MUCH           = "That lovely dish will cost you VALUE credits.",

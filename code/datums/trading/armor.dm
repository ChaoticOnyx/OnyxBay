/datum/trader/ship/armour
	...
	possible_trading_items = list(/obj/item/clothing/head/helmet 						= TRADER_THIS_TYPE,
								...
								/obj/item/clothing/suit/armor/pcarrier/light 			= TRADER_BLACKLIST,
								/obj/item/clothing/suit/armor/pcarrier/light/nt 		= TRADER_BLACKLIST,
								/obj/item/clothing/suit/armor/pcarrier/light/press 		= TRADER_BLACKLIST,
								/obj/item/clothing/suit/armor/pcarrier/medium 			= TRADER_BLACKLIST,
								/obj/item/clothing/suit/armor/pcarrier/medium/nt 		= TRADER_BLACKLIST,

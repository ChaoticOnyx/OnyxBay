...
/datum/beam/proc/Start()
	...
	Draw()
	register_signal(origin, SIGNAL_MOVED, nameof(.proc/redrawing))
	register_signal(target, SIGNAL_MOVED, nameof(.proc/redrawing))
...
/obj/effect/ebeam/proc/update_overlays()
	if(!emissive)
		return

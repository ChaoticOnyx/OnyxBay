...
DEFINE_BITFIELD(limb_flags, list(
	...
	"HAS_ARTERY" = ORGAN_FLAG_HAS_ARTERY,
	"CAN_EMBED" = ORGAN_FLAG_CAN_EMBED,
))
...
DEFINE_BITFIELD(snowflake_organs, list(
	"NO_AMPUTATE" = ORGAN_SNOWFLAKE_NO_AMPUTATE,
	"NO_BREAK" = ORGAN_SNOWFLAKE_NO_BREAK,
	"NO_TENDON" = ORGAN_SNOWFLAKE_NO_TENDON,
	"NO_ARTERY" = ORGAN_SNOWFLAKE_NO_ARTERY,
	"NO_EMBED" = ORGAN_SNOWFLAKE_NO_EMBED,
	"NO_DISLOCATE" = ORGAN_SNOWFLAKE_NO_DISLOCATE,
	"NO_PAIN" = ORGAN_SNOWFLAKE_NO_PAIN,
	"NO_BLEEDING" = ORGAN_SNOWFLAKE_NO_BLEEDING,
	"ROBOTIC" = ORGAN_SNOWFLAKE_ROBOTIC,
))

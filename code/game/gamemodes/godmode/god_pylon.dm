...
/obj/structure/deity/pylon/hear_talk(mob/M as mob, text, verb, datum/language/speaking)
	...
	to_chat(linked_god, "[icon2html(src, world, realsize=TRUE)] <span class='game say'><span class='name'>[M]</span> (<A href='?src=\ref[linked_god];jump=\ref[src];'>P</A>) [verb], [linked_god.pylon == src ? "<b>" : ""]<span class='message'><span class='body'>\"[text]\"</span></span>[linked_god.pylon == src ? "</b>" : ""]</span>")
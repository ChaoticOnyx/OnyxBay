...
/turf/floor/misc/fixed/attackby(obj/item/C, mob/user)
	if(istype(C, /obj/item/stack) && !isCoil(C))
		return
	return ..()

/turf/floor/misc/fixed/on_update_icon()
	return

/turf/floor/misc/fixed/is_plating()
	return 0

/turf/floor/misc/fixed/set_flooring()
	return

/turf/floor/misc/fixed/alium
	name = "alien plating"
	desc = "This obviously wasn't made for your feet."
	icon = 'icons/turf/flooring/alium.dmi'
	icon_state = "jaggy"

/turf/floor/misc/fixed/vox
	name = "alien plating"
	desc = "This obviously wasn't made for your feet."
	icon = 'icons/turf/flooring/alium.dmi'
	icon_state = "voxbase"
...
/turf/floor/misc/fixed/vox/vox2
	name = "alien plating"
	desc = "This obviously wasn't made for your feet."
	icon = 'icons/turf/flooring/alium.dmi'
	icon_state = "voxbase2"

/turf/floor/misc/fixed/vox/vox3
	name = "alien plating"
	desc = "This obviously wasn't made for your feet."
	icon = 'icons/turf/flooring/alium.dmi'
	icon_state = "voxplating1"

/turf/floor/misc/fixed/vox/vox4
	name = "alien plating"
	desc = "This obviously wasn't made for your feet."
	icon = 'icons/turf/flooring/alium.dmi'
	icon_state = "voxplating2"

/turf/floor/misc/fixed/alium/attackby(obj/item/C, mob/user)
	if(isCrowbar(C))
		to_chat(user, "<span class='notice'>There aren't any openings big enough to pry it away...</span>")
		return
	return ..()

/turf/floor/misc/fixed/alium/New()
	..()
...
/turf/floor/misc/fixed/alium/airless
	initial_gas = null
	temperature = TCMB

/turf/floor/misc/fixed/alium/ex_act(severity)
	var/material/A = get_material_by_name(MATERIAL_ALIUMIUM)

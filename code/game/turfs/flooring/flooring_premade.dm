...
/turf/floor/plating/snowed/smoothed
	icon = 'icons/turf/snow_turf.dmi'
	icon_state = "snow_turf-0-0"

/turf/floor/plating/snowed/smoothed/Initialize()
	. = ..()
	update_icon()
	redraw_nearby_snows()


/turf/floor/plating/snowed/smoothed/Destroy()
	redraw_nearby_snows()
	return ..()

/turf/floor/plating/snowed/smoothed/proc/redraw_nearby_snows()
	for(var/direction in GLOB.alldirs)
		var/turf/L = get_step(src, direction)
		if(istype(L,/turf/floor/plating/snowed/smoothed))
			L.update_icon() //so siding get updated properly


/turf/floor/plating/snowed/smoothed/on_update_icon()
	var/connectdir = 0
	for(var/direction in GLOB.cardinal)
		if(istype(get_step(src, direction),/turf/floor/plating/snowed/smoothed))
	...
	for(var/diag in list(NORTHEAST, SOUTHEAST,NORTHWEST,SOUTHWEST))
		if((connectdir & diag) == diag)
			if(istype(get_step(src, diag),/turf/floor/plating/snowed/smoothed))
...
/turf/floor/plating/snowed/temperatre
...
/turf/floor/grid/bluegrid/airless
	initial_gas = null

/turf/floor/grid/greengrid
	name = "mainframe floor"
	icon = 'icons/turf/flooring/circuit.dmi'
	icon_state = "gcircuit"
...
/turf/floor/grid/greengrid/airless
	initial_gas = null
...
/turf/floor/reinforced/plasma/fuel
...
/turf/floor/tiled/techfloor/maint
...
/turf/floor/plating/rough/airless
	name = "airless plating"
	initial_gas = null
	temperature = TCMB
...
/turf/floor/grid/greengrid/nitrogen
	initial_gas = list("nitrogen" = MOLES_N2STANDARD)
...
/turf/floor/trim/wood
	name = "wooden floor"
	icon = 'icons/turf/flooring/wood.dmi'
	icon_state = "wood"
	initial_flooring = /decl/flooring/wood

/turf/floor/trim/darkwood
...
/turf/floor/natural/frozenground/cave
	name = "frozen ground"
	icon = 'icons/turf/flooring/frozenground.dmi'
	icon_state = "wground1"
	temperature = 20 CELSIUS

/turf/floor/natural/frozenground/snow
	name = "snow"
	icon = 'icons/turf/snow.dmi'
	icon_state = "snow0"
	temperature = -30 CELSIUS

/turf/floor/natural/frozenground/snow/Initialize()
	if(prob(5))
...
/turf/floor/natural/lava/Crossed(O)
	. = ..()
	if(isliving(O))
		var/mob/living/M = O
		M.IgniteMob()

/turf/floor/natural/snow/New()
	icon_state = pick("snow[rand(1,12)]","snow0")
	..()

/turf/floor/natural/beach
	name = "beach"
	icon = 'icons/misc/beach.dmi'

/turf/floor/natural/beach/sand
	name = "sand"
	icon_state = "sand"

/turf/floor/natural/beach/sand/desert
	icon_state = "desert"
	has_resources = 1

/turf/floor/natural/beach/sand/desert/New()
	icon_state = "desert[rand(0,5)]"
	..()

/turf/floor/natural/beach/coastline
	name = "coastline"
	icon = 'icons/misc/beach2.dmi'
	icon_state = "sandwater"

/turf/floor/natural/beach/water
	name = "water"
	icon_state = "water"

/turf/floor/natural/beach/water/update_dirt()
	return	// Water doesn't become dirty

/turf/floor/natural/beach/water/ocean
	icon_state = "seadeep"

/turf/floor/natural/beach/water/New()
	..()
	AddOverlays(image("icon"='icons/misc/beach.dmi',"icon_state"="water5","layer"=MOB_LAYER+0.1))

//JUNGLE

/turf/floor/natural/jungle
	name = "grass"
	icon = 'icons/turf/jungle_turfs.dmi'
	icon_state = "grass1"
	footstep_sound = SFX_FOOTSTEP_GRASS

/turf/floor/natural/jungle/grasscorner1
	name = "grass"
	icon_state = "grassdirt_corner"

/turf/floor/natural/jungle/grasscorner2
	name = "grass"
	icon_state = "grassdirt_corner2"

/turf/floor/natural/jungle/grassedge
	name = "grass"
	icon_state = "grassdirt_edge"

/turf/floor/natural/jungle/sandgrassedge
	name = "grass"
	icon_state = "grasssand_edge"

/turf/floor/natural/jungle/sandgrasscorner1
	name = "grass"
	icon_state = "grasssand_corner"

/turf/floor/natural/jungle/sandgrasscorner2
	name = "grass"
	icon_state = "grasssand_corner2"
	footstep_sound = SFX_FOOTSTEP_ASTEROID

/turf/floor/natural/jungle/dirt
	name = "dirt"
	desc = "Looks dirty."
	icon_state = "dirt"

/turf/floor/natural/jungle/water
	name = "water"
	desc = "Looks wet."
	icon = 'icons/misc/beach.dmi'
...
/turf/floor/natural/jungle/water/New()
	..()
	if(overlay)
		AddOverlays(image("icon"='icons/misc/beach.dmi',"icon_state"="riverwater","layer"=MOB_LAYER+1))

/turf/floor/natural/jungle/water/edge
	icon_state = "beach"
	overlay = FALSE
/turf/floor/natural/jungle/water/corner
	icon_state = "beachcorner"
	overlay = FALSE
	footstep_sound = SFX_FOOTSTEP_ASTEROID

/turf/floor/natural/jungle/sand
	name = "sand"
	desc = "Looks sandy."
	icon = 'icons/misc/beach.dmi'
	icon_state = "desert0"
...
/turf/floor/natural/jungle/sand/New()
	if(rand_state)
		icon_state = "desert[rand(0, 5)]"
	..()
...
/turf/floor/natural/sand/New()
	if(rand_state)
		icon_state = "sand[rand(0, 12)]"
	..()

/turf/floor/natural/sand/cave
	name = "cave floor"

/turf/floor/natural/sand/pure
	rand_state = FALSE

/turf/floor/natural/sand/gray
	rand_state = FALSE
	icon_state = "sand_gray"
	base_icon_state = "sand_gray"

/turf/floor/natural/sand/darksand
	rand_state = FALSE
	icon_state = "asteroidplating"
	icon = 'icons/turf/floors.dmi'

/turf/floor/sand_floor
	name = "sand floor"
	icon = 'icons/turf/flooring/sand.dmi'
...
/turf/floor/misc/concrete
	name = "concrete"
	icon = 'icons/turf/flooring/misc.dmi'
	icon_state = "concrete"

/turf/floor/misc/diona
	name = "biomass"
	icon = 'icons/turf/floors.dmi'
	initial_flooring = /decl/flooring/diona

/turf/floor/misc/cult
	name = "engraved floor"
	icon = 'icons/turf/flooring/cult.dmi'
	icon_state = "cult"
	initial_flooring = /decl/flooring/reinforced/cult
	var/previous_type = /turf/floor

/turf/floor/misc/cult/cultify()
	return

/turf/floor/water/fountain
	name = "water"
	icon = 'icons/misc/beach.dmi'
	icon_state = "seadeep"

/turf/floor/water/fountain/Crossed(atom/movable/AM)

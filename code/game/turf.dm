...
/turf/simulated/wall/New()
	...
	if (north && west)
		if (istype(locate((north.x - 1), (north.y + 1), north.z), /turf/simulated/wall) && istype(locate((north.x - 1), north.y, north.z), /turf/simulated/wall))
		...
		if (istype(locate((west.x - 1), (west.y + 1), west.z), /turf/simulated/wall) && istype(locate(west.x, (west.y + 1), west.z), /turf/simulated/wall))
	...
	if (north && east)
		...
		if (istype(locate((east.x + 1), (east.y + 1), east.z), /turf/simulated/wall) && istype(locate(east.x, (east.y + 1), east.z), /turf/simulated/wall))
		...
		S.overlays += image('walls.dmi',icon_state="wall1",dir=NORTHEAST)
	if (south && west)
		if (istype(locate((south.x - 1), (south.y - 1), south.z), /turf/simulated/wall) && istype(locate((south.x - 1), south.y, south.z), /turf/simulated/wall))

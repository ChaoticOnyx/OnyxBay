...
/obj/machinery/media/jukebox
	...
	var/list/datum/track/tracks = list(
		...
		new/datum/track("Reaper&Blues", 'sound/music/reaperblues.ogg'),
		new/datum/track("Undead Walking", 'sound/music/undead.ogg'),
		new/datum/track("Rum", 'sound/music/rum.ogg'),
		new/datum/track("Space Asshole", 'sound/music/spaceasshole.ogg'),
		new/datum/track("Moonlight and Vodka", 'sound/music/moonlight.ogg'),

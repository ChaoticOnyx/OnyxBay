...
/datum/autolathe/recipe/magazine_uzi
	...
	path = /obj/item/ammo_magazine/c45uzi/nt
	hidden = 1
	category = "Arms and Ammunition"

/datum/autolathe/recipe/magazine_deagle
	name = "ammunition (.50 AE)"
	path = /obj/item/ammo_magazine/a50/nt
	hidden = 1
	category = "Arms and Ammunition"

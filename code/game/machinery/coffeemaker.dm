...
/obj/machinery/coffeemaker
	...
	var/static/coffepot_empty = image(icon, "pot_full")
	var/static/coffeepot_full = image(icon, "pot_empty")
	var/static/cups_1 = image(icon, "cups_1")
	var/static/cups_2 = image(icon, "cups_2")
	var/static/cups_3 = image(icon, "cups_3")
	var/static/sugar_packs_overlay = image(icon, "extras_1")
	var/static/creamer_packs_overlay = image(icon, "extras_1")
	var/static/sweetener_packs_overlay = image(icon, "extras_1")
	var/static/grinder_half = image(icon, "grinder_half")
	var/static/grinder_full = image(icon, "grinder_full")

...
/obj/machinery/embedded_controller/radio/airlock/advanced_airlock_controller/ui_interact(mob/user, ui_key = "main", datum/onyxui/ui = null, force_open = 1, datum/onyxui/master_ui = null, datum/topic_state/state = GLOB.default_state)
	var/data[0]
...
/obj/machinery/embedded_controller/radio/airlock/airlock_controller/ui_interact(mob/user, ui_key = "main", datum/onyxui/ui = null, force_open = 1, datum/onyxui/master_ui = null, datum/topic_state/state = GLOB.default_state)
	var/data[0]
...
/obj/machinery/embedded_controller/radio/airlock/access_controller/ui_interact(mob/user, ui_key = "main", datum/onyxui/ui = null, force_open = 1, datum/onyxui/master_ui = null, datum/topic_state/state = GLOB.default_state)
	var/data[0]

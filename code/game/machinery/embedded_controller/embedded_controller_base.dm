...
/obj/machinery/embedded_controller/ui_interact(mob/user, ui_key = "main", datum/onyxui/ui = null, force_open = 1, datum/onyxui/master_ui = null, datum/topic_state/state = GLOB.default_state)
	return

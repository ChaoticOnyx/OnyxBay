...
obj/machinery/recharger/attackby(obj/item/weapon/G as obj, mob/user as mob)
	...
	if(allowed)
		...
		if (istype(G, /obj/item/weapon/gun/energy/plasmacutter))
			to_chat(user, SPAN_NOTICE("It's seems like plasma cutter have another type of charging port, so it doesn't fit in this device, perhaps you could use solid photon crystals for recharging it"))
			return

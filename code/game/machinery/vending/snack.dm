...
/obj/machinery/vending/snack
	...
	vend_delay = 25
	rand_amount = TRUE
	products = list(/obj/item/reagent_containers/food/packaged/tweakers = 6,
	...
	contraband = list(/obj/item/reagent_containers/food/packaged/syndicake = 6,
...
/obj/machinery/vending/snack/medbay
	...
	use_vend_state = TRUE
	vend_delay = 25
	products = list(/obj/item/reagent_containers/food/grown/apple = 10,
					...
					/obj/item/reagent_containers/food/packaged/tastybread = 10)
	contraband = list(/obj/item/reagent_containers/food/packaged/hemptogen = 3,
					  /obj/item/reagent_containers/food/packaged/skrellsnacks = 3)

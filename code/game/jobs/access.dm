...
/proc/get_access(job)
	switch(job)
		...
		if("Station Engineer")
			return list(access_engine, access_engine_equip, access_tech_storage, access_maint_tunnels, access_external_airlocks, access_laboratories_doors)
		if("Assistant")
		...
		if("Security Officer")
			return list(access_security, access_laboratories_doors, access_brig, access_forensics_lockers, access_maint_tunnels, access_medical, access_security_passthrough)
		if("Scientist")
		...
		if("Head of Security")
			return list(access_medical, access_morgue, access_tox, access_tox_storage, access_chemistry, access_medlab,
			            ...
			            access_maint_tunnels, access_bar, access_janitor, access_kitchen, access_robotics, access_laboratories_doors,
			             access_armory, access_engine, access_security_passthrough)
		if("Head of Personnel")
			return list(access_security, access_brig, access_forensics_lockers,
			            ...
			            access_security_passthrough, access_laboratories_doors)
		...
		if("Janitor")
			return list(access_janitor, access_maint_tunnels, access_laboratories_doors)
		if("Clown")
			return list()
		if("Chef")

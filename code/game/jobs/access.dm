...
/proc/get_access(job)
	switch(job)
		...
		if("Anomalist")
			return list(access_tox, access_chemistry, access_maint_tunnels, access_medlab, access_laboratories_doors)
		if("Janitor")
...
/proc/get_type_jobs(T)
	switch(T)
		...
		if ("Med/Sci")
			return list("Chemist", "Geneticist", "Scientist", "Roboticist", "Medical Doctor","Anomalist")
		if ("Maintenance")

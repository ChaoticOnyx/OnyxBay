...
/obj/mecha/proc/clearInternalDamage(int_dam_flag)
	...
	switch(int_dam_flag)
		if(MECHA_INT_TEMP_CONTROL)
			occupant_message("<span class='info'><b>Life support system reactivated.</b></span>")
			pr_int_temp_processor.start()
		if(MECHA_INT_FIRE)
			occupant_message("<span class='info'><b>Internal fire extinquished.</b></span>")
		if(MECHA_INT_TANK_BREACH)
			occupant_message("<span class='info'><b>Damaged internal tank has been sealed.</b></span>")
	return
...
/obj/mecha/attackby(obj/item/W, mob/user)
	if(istype(W, /obj/item/organ/internal/mastermind/mmi))
	...
	if(istype(W, /obj/item/organ/internal/mastermind/posibrain))
...
/obj/mecha/proc/move_mmi_inside(obj/item/organ/internal/mastermind/mmi/MMI, mob/user)
...
/obj/mecha/proc/move_posibrain_inside(obj/item/organ/internal/mastermind/posibrain/PB, mob/user)
...
/obj/mecha/proc/go_out()
	...
	if(mob_container.forceMove(loc))//ejecting mob container
		...
		if(istype(mob_container, /obj/item/organ/internal/mastermind/mmi))
			var/obj/item/organ/internal/mastermind/mmi/mmi = mob_container
			if(mmi.brainmob)
				occupant.loc = mmi
			verbs += /obj/mecha/verb/eject
		if(istype(mob_container, /obj/item/organ/internal/mastermind/posibrain))
			var/obj/item/organ/internal/mastermind/posibrain/pb = mob_container
			if(pb.brainmob)
				occupant.loc = pb
			verbs += /obj/mecha/verb/eject

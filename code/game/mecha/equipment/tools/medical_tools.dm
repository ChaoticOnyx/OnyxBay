...
/obj/item/mecha_parts/mecha_equipment/tool/sleeper/proc/get_occupant_dam()
	...
	return {"<font color="[occupant.health > 50 ? "blue" : "red"]"><b>Health:</b> [occupant.health]% ([t1])</font><br />
				<font color="[occupant.bodytemperature > 50 ? "blue" : "red"]"><b>Core Temperature:</b> [convert_k2c(src.occupant.bodytemperature)]&deg;C ([src.occupant.bodytemperature*1.8-459.67]&deg;F)</font><br />

...
/datum/abductor_gear
	var/name = "Generic Abductor Gear"		 // Name of the gear
	var/description = "Generic description." // Description of the gear
	var/id = "abductor_generic"	// Unique ID of the gear
	var/cost = 1 				// Credit cost of the gear
	var/build_path = null 		// Build path of the gear itself
	var/category = "Basic Gear"	// Category of the gear

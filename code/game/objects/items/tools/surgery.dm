...
/obj/item/FixOVein/clot
	...
	desc = "A canister like tool that stores advanced synthetic vein."
	icon_state = "clot"
	item_state = "clot"
	surgery_speed = 0.5

/obj/item/device/floor_painter
	...
	var/list/decals = list(
		...
		"sign: A" =                 list("path" = /obj/effect/floor_decal/sign/a),
		"sign: B" =                 list("path" = /obj/effect/floor_decal/sign/b),
		"sign: C" =                 list("path" = /obj/effect/floor_decal/sign/c),
		"sign: D" =                 list("path" = /obj/effect/floor_decal/sign/d),
		"sign: M" =                 list("path" = /obj/effect/floor_decal/sign/m),
		"sign: V" =                 list("path" = /obj/effect/floor_decal/sign/v),
		"sign: CMO" =               list("path" = /obj/effect/floor_decal/sign/cmo),
		"sign: Ex" =                list("path" = /obj/effect/floor_decal/sign/ex),
		"sign: Psy" =               list("path" = /obj/effect/floor_decal/sign/p),

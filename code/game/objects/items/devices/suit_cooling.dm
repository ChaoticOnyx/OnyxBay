/obj/item/device/suit_cooling_unit
	...
	description_info = "You may wear this instead of your packpack to cool yourself down. It is commonly used by xenos, \
	...
	description_fluff = "Before the advent of ultra-heat-resistant fibers and flexible alloyed shielding, portable coolers were most commonly used to keep technicians from roasting alive in their suits."

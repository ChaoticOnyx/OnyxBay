...
// TOBACCO //
/////////////
/obj/item/weapon/reagent_containers/food/snacks/tobacco // tobacco is a snack, tasty and delicious
	name = "tobacco pile"
...
/obj/item/weapon/reagent_containers/food/snacks/tobacco/menthol
...
/obj/item/weapon/reagent_containers/food/snacks/tobacco/chocolate
...
/obj/item/weapon/reagent_containers/food/snacks/tobacco/premium
...
// Packs
/obj/item/weapon/storage/tobaccopack
	name = "tobacco bag"
...
/obj/item/weapon/storage/tobaccopack/generic
	name = "bag of StarLing Classic"
	desc = "A bag of tobacco."
	icon_state ="tobacco_generic"
	startswith = list(/obj/item/weapon/reagent_containers/food/snacks/tobacco/generic = 10)

/obj/item/weapon/storage/tobaccopack/cherry
	name = "bag of StarLing Cherry"
	desc = "A bag of cherry-flavored tobacco."
	icon_state ="tobacco_cherry"
	startswith = list(/obj/item/weapon/reagent_containers/food/snacks/tobacco/cherry = 10)

/obj/item/weapon/storage/tobaccopack/menthol
	name = "bag of StarLing Menthol"
	desc = "A bag of menthol-flavored tobacco."
	icon_state ="tobacco_menthol"
	startswith = list(/obj/item/weapon/reagent_containers/food/snacks/tobacco/menthol = 10)

/obj/item/weapon/storage/tobaccopack/chocolate
	name = "bag of StarLing Chocolate"
	desc = "A bag of chocolate-flavored tobacco."
	icon_state ="tobacco_chocolate"
	startswith = list(/obj/item/weapon/reagent_containers/food/snacks/tobacco/chocolate = 10)

/obj/item/weapon/storage/tobaccopack/premium
	name = "box of Admiral's Pipe"
	desc = "A small metal box of high-quality tobacco."
	icon_state ="tobacco_premium"
	startswith = list(/obj/item/weapon/reagent_containers/food/snacks/tobacco/premium = 10)

/obj/item/weapon/storage/tobaccopack/contraband
	name = "bag of Rawdmann's"
	desc = "A bag of... whatever is this."
	icon_state ="tobacco_contraband"
	startswith = list(/obj/item/weapon/reagent_containers/food/snacks/tobacco/contraband = 10)

...
/obj/item/weapon/circuitboard/stationalert/construct(obj/machinery/computer/station_alert/SA)
	if(..(SA))
		SA.unregister_monitor()

		var/datum/onyxui_module/alarm_monitor/monitor = new(SA)
...
/obj/item/weapon/circuitboard/stationalert/deconstruct(obj/machinery/computer/station_alert/SA)
	if(..(SA))
		alarm_handlers.Cut()
		if(SA.alarm_monitor)

...
/obj/item/weapon/circuitboard/holodeckcontrol/construct(obj/machinery/computer/HolodeckControl/HC)
	if (..(HC))
...
/obj/item/weapon/circuitboard/holodeckcontrol/deconstruct(obj/machinery/computer/HolodeckControl/HC)
	if (..(HC))

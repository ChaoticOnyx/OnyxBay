...
/obj/item/weapon/card/id/attack_self(mob/user as mob)
	user.visible_message("\The [user] shows you: [GUNCHAT_ICON(src)] [src.name]. The assignment on the card: [src.assignment]",\
		"You flash your ID card: [GUNCHAT_ICON(src)] [src.name]. The assignment on the card: [src.assignment]")
...
/obj/item/weapon/card/id/verb/read()
	...
	to_chat(usr, "[GUNCHAT_ICON(src)] [src.name]: The current assignment on the card is [src.assignment].")

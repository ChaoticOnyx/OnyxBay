...
/obj/item/weapon/card/id/attack_self(mob/user as mob)
	user.visible_message("\The [user] shows you: [icon2html(src, viewers(user), realsize=FALSE)] [src.name]. The assignment on the card: [src.assignment]",\
		"You flash your ID card: [icon2html(src,  viewers(user), realsize=FALSE)] [src.name]. The assignment on the card: [src.assignment]")
...
/obj/item/weapon/card/id/verb/read()
	...
	to_chat(usr, "[icon2html(src, usr, realsize=FALSE)] [src.name]: The current assignment on the card is [src.assignment].")

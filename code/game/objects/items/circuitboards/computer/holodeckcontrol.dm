...
/obj/item/circuitboard/holodeckcontrol/construct(obj/machinery/computer/HolodeckControl/HC)
	if (..(HC))
...
/obj/item/circuitboard/holodeckcontrol/deconstruct(obj/machinery/computer/HolodeckControl/HC)
	if (..(HC))

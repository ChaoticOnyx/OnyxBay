...
/obj/structure/janitorialcart/examine(mob/user)
	if(..(user, 1))
		to_chat(user, "[src] [GUNCHAT_ICON(src)] contains [reagents.total_volume] unit\s of liquid!")
...
/obj/structure/bed/chair/janicart/examine(mob/user)
	...
	to_chat(user, "[GUNCHAT_ICON(src)] This [callme] contains [reagents.total_volume] unit\s of water!")
	if(mybag)

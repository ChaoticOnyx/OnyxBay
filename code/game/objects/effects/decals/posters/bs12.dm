...
/datum/poster/bay_63
	...
	name = "joy"
	desc = "The poster depicts a large blue round pill against the backdrop of a daytime desert. Joy"
...
/datum/poster/bay_65
	...
	name = "ETA 00:00"
	desc = "This poster captures the whole point of the crew being late to the departure shuttle. Nuff said."
...
/datum/poster/bay_69
	...
	name = "don't run with scissors!"
	desc = "The poster shows a road sign with scissors drawn on it. Perhaps you really shouldn't be running down the halls with scissors. That's good advice."

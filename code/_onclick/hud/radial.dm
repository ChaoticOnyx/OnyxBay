...
*/
/proc/show_radial_menu(mob/user, atom/anchor, list/choices, uniqueid, radius = 32, datum/callback/custom_check, require_near = FALSE, in_screen = FALSE, use_hudfix_method = TRUE)
	radius *= 1 + 0.05 * choices.len

...
/obj/machinery/turretcp/BorgCtrlClick() //turret control on/off. Forwards to AI code.
	AICtrlClick()
...
/obj/machinery/turretcp/BorgAltClick() //turret lethal on/off. Forwards to AI code.
	AIAltClick()

...
/obj/item/weapon/computer_hardware/nano_printer/proc/print_text(text_to_print, paper_title = null, rawhtml = FALSE)
	if(!stored_paper)
		return 0
	if(!enabled)
		return 0
	...
	new /obj/item/weapon/paper(get_turf(holder2), text_to_print, paper_title, rawhtml)

/obj/item/modular_computer/proc/update_verbs()
	verbs.Cut()
	if(ai_slot)
		add_verb(src, /obj/item/modular_computer/verb/eject_ai)
	if(portable_drive)
		add_verb(src, /obj/item/modular_computer/verb/eject_usb)
	if(card_slot)
		add_verb(src, /obj/item/modular_computer/verb/eject_id)
	add_verb(src, /obj/item/modular_computer/verb/emergency_shutdown)

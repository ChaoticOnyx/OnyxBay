/datum/computer_file/program/alarm_monitor
	...
	nanomodule_path = /datum/onyxui_module/alarm_monitor/engineering
...
/datum/computer_file/program/alarm_monitor/process_tick()
	..()
	var/datum/onyxui_module/alarm_monitor/NMA = NM
...
/datum/onyxui_module/alarm_monitor
	name = "Alarm monitor"
	var/list_cameras = 0						// Whether or not to list camera references. A future goal would be to merge this with the enginering/security camera console. Currently really only for AI-use.
	var/list/datum/alarm_handler/alarm_handlers // The particular list of alarm handlers this alarm monitor should present to the user.
	available_to_ai = FALSE

/datum/onyxui_module/alarm_monitor/New()
	..()
	alarm_handlers = list()
...
/datum/onyxui_module/alarm_monitor/all/New()
	..()
	alarm_handlers = SSalarm.all_handlers

/datum/onyxui_module/alarm_monitor/engineering/New()
	..()
	alarm_handlers = list(atmosphere_alarm, camera_alarm, fire_alarm, power_alarm)

/datum/onyxui_module/alarm_monitor/security/New()
	..()
	alarm_handlers = list(camera_alarm, motion_alarm)

/datum/onyxui_module/alarm_monitor/proc/register_alarm(object, procName)
	for(var/datum/alarm_handler/AH in alarm_handlers)
		AH.register_alarm(object, procName)

/datum/onyxui_module/alarm_monitor/proc/unregister_alarm(object)
	for(var/datum/alarm_handler/AH in alarm_handlers)
		AH.unregister_alarm(object)

/datum/onyxui_module/alarm_monitor/proc/all_alarms()
...
/datum/onyxui_module/alarm_monitor/proc/major_alarms()
	var/list/all_alarms = new()
	for(var/datum/alarm_handler/AH in alarm_handlers)
...
/datum/onyxui_module/alarm_monitor/proc/has_major_alarms()
	for(var/datum/alarm_handler/AH in alarm_handlers)
...
/datum/onyxui_module/alarm_monitor/proc/minor_alarms()
	var/list/all_alarms = new()
	for(var/datum/alarm_handler/AH in alarm_handlers)
...
/datum/onyxui_module/alarm_monitor/Topic(ref, href_list)
	if(..())
		return 1
...
/datum/onyxui_module/alarm_monitor/ui_interact(mob/user, ui_key = "main", datum/onyxui/ui = null, force_open = 1, datum/topic_state/state = GLOB.default_state)

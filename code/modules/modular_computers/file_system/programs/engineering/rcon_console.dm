/datum/computer_file/program/rcon_console
	...
	nanomodule_path = /datum/onyxui_module/rcon
...
/datum/onyxui_module/rcon/ui_interact(mob/user, ui_key = "rcon", datum/onyxui/ui=null, force_open=1, datum/topic_state/state = GLOB.default_state)
...
/datum/onyxui_module/rcon/Topic(href, href_list)
	if(..())
		return
...
/datum/onyxui_module/rcon/proc/GetSMESByTag(tag)
	if(!tag)
		return
...
/datum/onyxui_module/rcon/proc/FindDevices()

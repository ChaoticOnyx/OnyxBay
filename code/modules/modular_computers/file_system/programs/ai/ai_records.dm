/datum/computer_file/program/records/ai
	...
	nanomodule_path = /datum/onyxui_module/records/ai
...
/datum/onyxui_module/records/ai/generate_updated_data()
	var/list/data = ..()
	ASSERT(istype(data))
...
/datum/onyxui_module/records/ai/edit_field(mob/user, field)

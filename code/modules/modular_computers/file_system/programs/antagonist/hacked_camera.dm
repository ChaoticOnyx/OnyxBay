/datum/computer_file/program/camera_monitor/hacked
	...
	nanomodule_path = /datum/onyxui_module/camera_monitor/hacked
...
/datum/computer_file/program/camera_monitor/hacked/process_tick()
	...
	var/datum/onyxui_module/camera_monitor/hacked/HNM = NM
...
/datum/onyxui_module/camera_monitor/hacked
	name = "Hacked Camera Monitoring Program"
	available_to_ai = FALSE

/datum/onyxui_module/camera_monitor/hacked/can_access_network(mob/user, network_access)
	return 1

// The hacked variant has access to all commonly used networks.
/datum/onyxui_module/camera_monitor/hacked/modify_networks_list(list/networks)
	networks.Add(list(list("tag" = NETWORK_SYNDICATE, "has_access" = 1)))

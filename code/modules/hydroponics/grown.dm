...
/obj/item/weapon/reagent_containers/food/snacks/grown/Crossed(mob/living/M)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/apply_hit_effect(mob/living/target, mob/living/user, hit_zone)
	. = ..()

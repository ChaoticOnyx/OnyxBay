...
/obj/item/book/wiki/robotics_cyborgs
	...
	attack_verb = list("bashed", "whacked", "educated", "borged", "cybernetized")
...
/obj/item/book/wiki/supermatter_engine
	...
	attack_verb = list("bashed", "whacked", "educated", "superbashed", "superwhacked")
...
/obj/item/book/wiki/rust_engine
	...
	topic = "RUST"
	attack_verb = list("bashed", "whacked", "educated", "rusted", "operated")
...
/obj/item/book/wiki/engineering_hacking
	...
	attack_verb = list("bashed", "whacked", "educated", "hacked", "pentested", "reverse-engineered")
...
/obj/item/book/wiki/engineering_singularity_safety
	...
	attack_verb = list("bashed", "whacked", "educated", "singulated", "accelerated")
...
/obj/item/book/wiki/atmospipes
	...
	attack_verb = list("bashed", "whacked", "educated", "pressurized", "sealed")
...
/obj/item/book/wiki/chef_recipes
	...
	title = "Chef Recipes"
	topic = "Guide to Food"
	attack_verb = list("bashed", "whacked", "educated", "culinarized", "chefed")
...
/obj/item/book/wiki/barman_recipes
	...
	attack_verb = list("bashed", "whacked", "educated", "bartended")
...
/obj/item/book/wiki/detective
	...
	attack_verb = list("bashed", "whacked", "educated", "investigated", "noired")
...
/obj/item/book/wiki/nuclear
	...
	censored = 0
	attack_verb = list("bashed", "whacked", "educated", "nuked", "sabotaged")
...
/obj/item/book/wiki/research_and_development
	...
	attack_verb = list("bashed", "whacked", "educated", "researched", "developed")
...
/obj/item/book/wiki/excavation
	...
	attack_verb = list("bashed", "whacked", "educated", "excavated")
...
/obj/item/book/wiki/medical_chemistry
	...
	style = WIKI_MOBILE
	attack_verb = list("bashed", "whacked", "educated", "cooked", "synthesized")
...
/obj/item/book/wiki/chain_of_command
	...
	window_width = 800
	attack_verb = list("bashed", "whacked", "educated", "commanded")
...
/obj/item/book/wiki/grammar
	...
	window_width = 800
	style = WIKI_MOBILE
	attack_verb = list("bashed", "whacked", "educated", "educated", "educated")

/obj/item/book/wiki/surgery
	topic = "Guide to Surgery"
	style = WIKI_MOBILE
	attack_verb = list("bashed", "whacked", "educated", "surgically bashed", "sterilely whacked")

/obj/item/book/wiki/paperworks
	topic = "Guide to Paperworks"
	style = WIKI_MOBILE
	attack_verb = list("bashed", "whacked", "educated", "bureaucrated", "paperworked")
...
/obj/item/book/wiki/syndicate
	topic = "Syndicate"
	style = WIKI_MOBILE
	attack_verb = list("bashed", "whacked", "educated", "syndicated", "betrayed")

/obj/item/book/wiki/vox
	topic = "Vox"
	style = WIKI_MOBILE
	attack_verb = list("bashed", "whacked", "educated", "birded", "aviated")

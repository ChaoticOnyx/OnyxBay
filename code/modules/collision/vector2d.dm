...
*/
/datum/vector2d/proc/dot(datum/vector2d/other)
...
*/
/datum/vector2d/proc/cross(datum/vector2d/other)
...
*/
/datum/vector2d/proc/project(datum/vector2d/other)
	RETURN_TYPE(/datum/vector2d)
...
/datum/vector2d/proc/project_n(datum/vector2d/other)
	RETURN_TYPE(/datum/vector2d)
...
*/
/datum/vector2d/proc/copy(datum/vector2d/other)
	src.x = other.x
	src.y = other.y

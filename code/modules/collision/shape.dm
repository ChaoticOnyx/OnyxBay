...
*/
/datum/shape/proc/set_angle(angle)
	if(angle == src._angle)
		return FALSE
...
*/
/datum/shape/proc/collides(datum/shape/other, datum/collision_response/c_response)
	if(!test_aabb(other))
		return FALSE
...
*/
/datum/shape/proc/get_collision_point(datum/shape/other)

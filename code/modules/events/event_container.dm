...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Borer Infection", /datum/event/borer_infection,	35,	list(ASSIGMENT_SECURITY = 10), is_one_shot = TRUE),
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Borer Infection", /datum/event/borer_infection,	5,	list(ASSIGMENT_ANY = 5), is_one_shot = TRUE),

...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta/no_overmap(EVENT_LEVEL_MODERATE, "Carp School",             /datum/event/carp_migration,             100,    list(ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_SECURITY = 20), is_one_shot = 1),
		...
		new /datum/event_meta/extended_penalty(EVENT_LEVEL_MODERATE, "Random Antagonist", /datum/event/random_antag,               2.5,    list(ASSIGNMENT_SECURITY = 1), is_one_shot = 1, 0, 5),
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta/no_overmap(EVENT_LEVEL_MAJOR, "Carp Migration",        /datum/event/carp_migration,        0,     list(ASSIGNMENT_SECURITY = 5)),

...
/obj/item/melee/energy/sword/saber
	description_antag = "The energy saber is a very strong melee weapon, capable of severing limbs easily, if they are targeted.  It is also capable of \
	easily deflecting projectiles and melee attacks while it is on and being held.  The sword can be toggled on or off by using it in your hand.  While it is off, \

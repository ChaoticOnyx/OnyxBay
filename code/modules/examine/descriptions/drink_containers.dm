...
/obj/item/weapon/reagent_containers/food/drinks/cans/grape_juice
	description_fluff = "Made by the Robust Industries sub-corporation, Grape!, the product line claims that they use the same grapes that this juice is made of to make their wine. Either way, it contains real fruit, imagine that."

/obj/item/weapon/reagent_containers/food/drinks/cans/tonic
	description_fluff = "Endorsed by the popular positronic rapper, T-Borg, this beverage is advertised as a 'high class' drink. Most people just use it to mix with their gin, and not much can be said about the quality."

/obj/item/weapon/reagent_containers/food/drinks/cans/sodawater
	description_fluff = "Considered by many to be proof that Robust Industries sells no non-carbonated beverages, lack of sugar or flavoring agents means this stuff isn't exactly flying off of the shelves."

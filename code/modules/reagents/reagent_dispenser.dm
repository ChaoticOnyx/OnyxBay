...
/obj/structure/reagent_dispensers/fueltank/proc/explode()
	if (reagents.total_volume > 500)
		explosion(get_turf(src.loc),1,2,4,sfx_to_play="fuel_explosion")
	else if (reagents.total_volume > 100)
		explosion(get_turf(src.loc),0,1,3,sfx_to_play="fuel_explosion")
	else if (reagents.total_volume > 50)
		explosion(get_turf(src.loc),-1,1,2,sfx_to_play="fuel_explosion")
	if(src)
		qdel(src)

...
/obj/item/reagent_containers/food/pie
	...
	startswith = list(
		...
		/datum/reagent/drink/juice/banana = 1
		)
...
/obj/item/reagent_containers/food/cherrypie
	...
	startswith = list(
		...
		/datum/reagent/nutriment/cherryjelly = 1
		)
	bitesize = 3 // 300 nutrition, 6 bites
...
/obj/item/reagent_containers/food/meatpie
	...
	bitesize = 2.5 // 570 nutrition, 12 bites
...
/obj/item/reagent_containers/food/amanita_pie
	...
	nutriment_amt = 12
	startswith = list(
		/datum/reagent/nutriment/protein/gluten/cooked = 3 // Let's keep the basic stuff safe since amanitas w/ TRAIT_POTENCY=0 are non-toxic, we can get all the funny stuff during cooking.
		)
...
/obj/item/reagent_containers/food/plump_pie
	...
	nutriment_amt = 12
	startswith = list(
		/datum/reagent/nutriment/protein/gluten/cooked = 3 // The same as above.
		)
	bitesize = 3 // 195+ nutrition, 5+ bites

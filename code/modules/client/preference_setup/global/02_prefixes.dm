...
/datum/category_item/player_setup_item/player_global/prefixes/load_preferences(savefile/S)
...
/datum/category_item/player_setup_item/player_global/prefixes/save_preferences(savefile/S)

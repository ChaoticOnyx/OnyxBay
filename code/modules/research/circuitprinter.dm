...
/obj/machinery/r_n_d/circuit_imprinter
	...
	var/list/item_type = list("Machine Boards", "Console Boards", "Mecha Boards", "Module Boards", "Engineering Boards")
...
/obj/machinery/r_n_d/circuit_imprinter/Process()
	...
	if(canBuild(D))
		...
		if(busy)
			visible_message("<span class='notice'><[GUNCHAT_ICON(src)] flashes: insufficient materials: [getLackingMaterials(D)].</span>")
			busy = 0
			update_icon()

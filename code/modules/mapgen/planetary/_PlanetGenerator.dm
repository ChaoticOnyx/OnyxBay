...
/datum/map_generator/planet_generator
	...
	var/area/primary_area_type = /area/generated/planetoid
	...
	var/area/cave_area_type = /area/generated/planetoid/cave
	...
	/// Weather controller of this planet's Z-level. Can be null, also.
...
/datum/map_generator/planet_generator/_populate_turf(turf/gen_turf)
	var/area/A = gen_turf.loc
	if(!(A.area_flags & AREA_FLAG_CAVES_ALLOWED))
		return

	var/datum/biome/turf_biome = get_biome(gen_turf)
	turf_biome._populate_turf(gen_turf, created_features, created_mobs)

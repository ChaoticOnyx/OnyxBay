...
/obj/structure/closet/crate/secure/loot/proc/generate_loot()
	...
	switch(loot)
		if(1 to 5) // Common things go, 5%
			new /obj/item/reagent_containers/vessel/bottle/rum(src)
			new /obj/item/reagent_containers/vessel/bottle/whiskey(src)
			new /obj/item/reagent_containers/food/grown/ambrosiadeus(src)
		...
		if(26 to 30)
			for(var/i = 0, i < 3, i++)
				new /obj/item/reagent_containers/vessel/beaker/noreact(src)
		if(31 to 35)
		...
		if(95)
			...
			new /obj/item/reagent_containers/vessel/bottle/bottleofnothing(src)
		if(96)

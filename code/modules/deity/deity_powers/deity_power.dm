/datum/deity_power
	...
	/// Set to true so this power will manifest immediately, without clicking on something.
	var/manifest_on_select = FALSE
	...
	var/icon
	var/icon_state
	/// If you can't switch to another power (e.g. thalamus droppod start)
	var/can_switch = TRUE

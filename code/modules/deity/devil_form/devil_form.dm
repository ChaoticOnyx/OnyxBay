...
/datum/god_form/devil/take_charge(mob/living/user, charge)
...
/datum/god_form/devil/setup_form(mob/living/deity/D)
	. = ..()
...
/datum/god_form/devil/proc/grant_spells(mob/living/human_shell, list/spells)

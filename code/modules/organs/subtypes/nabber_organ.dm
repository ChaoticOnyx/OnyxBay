...
/obj/item/organ/internal/eyes/nabber/think()
	if(eyes_shielded)
		owner.eye_blind = 20
	..()
...
/obj/item/organ/internal/plasma/think()
	if(owner)
		var/amount = 0.1
		if(is_broken())
			amount *= 0.5
...
/obj/item/organ/internal/liver/nabber/think()
	if(owner)
		var/amount = 0.8
		if(is_broken())
			amount *= 0.5
...
/obj/item/organ/internal/brain/nabber/think()

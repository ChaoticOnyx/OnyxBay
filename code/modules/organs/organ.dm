...
/obj/item/organ/proc/is_preserved()
	if(istype(loc,/obj/item/organ))
		...
		return (istype(loc,/obj/item/organ/internal/mastermind/mmi) || istype(loc,/obj/structure/closet/body_bag/cryobag) || istype(loc,/obj/structure/closet/crate/freezer) || istype(loc,/obj/item/storage/box/freezer) || istype(loc,/mob/living/simple_animal/hostile/little_changeling))

/datum/onyxui_module/usage_info
	name = "Usage Info"
	available_to_ai = 0
	var/datum/sound_player/player

/datum/onyxui_module/usage_info/New(atom/source, datum/sound_player/player)
	src.host = source
	src.player = player
...
/datum/onyxui_module/usage_info/ui_interact(mob/user, ui_key = "usage_info", datum/onyxui/ui = null, force_open = 0)
...
/datum/onyxui_module/usage_info/Destroy()
	player = null
	..()

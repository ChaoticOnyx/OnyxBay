/obj/item/clothing/suit/bio_suit/anomaly
	...
	icon_state = "bio_anom"
	item_state = "bio_anom"
	armor_values = alist(melee = 0, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 100)
...
/obj/item/clothing/suit/space/void/excavation
	...
	icon_state = "excavation_voidsuit"
	item_state = "excavation_voidsuit"
	armor_values = alist(melee = 30, bullet = 0, laser = 5,energy = 40, bomb = 35, bio = 100)

...
GLOBAL_LIST_INIT(target_interested_atoms, typecacheof(list(/mob, /obj/machinery/turret, /obj/mecha)))
...
/datum/ai_behavior/find_potential_targets/proc/failed_to_find_anyone(datum/ai_controller/controller, target_key, targeting_strategy_key, hiding_location_key)
	...
	aggro_range = max(aggro_range, round(world.view / 2))
	...
	var/datum/proximity_monitor/detection_field = null
	//advanced/ai_target_tracking/detection_field = new(
	//	controller.pawn,
	//	aggro_range,
	//	TRUE,
	//	src,

...
/client/proc/cmd_debug_mob_lists()
	...
	switch(input("Which list?") in list("Players","Admins","Mobs","Living Mobs","Dead Mobs", "Ghost Mobs", "Clients"))
		...
		if("Mobs")
			to_chat(usr, jointext(SSmobs.mob_list,","), confidential = TRUE)
		if("Living Mobs")
			to_chat(usr, jointext(GLOB.living_mob_list_,","), confidential = TRUE)
		if("Dead Mobs")
			to_chat(usr, jointext(GLOB.dead_mob_list_,","), confidential = TRUE)
		if("Ghost Mobs")
			to_chat(usr, jointext(GLOB.ghost_mob_list,","), confidential = TRUE)
		if("Clients")

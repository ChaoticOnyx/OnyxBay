...
/datum/build_mode/throw_at/proc/SetThrowable(new_throwable)
	...
	register_signal(to_throw, SIGNAL_DESTROY, /datum/build_mode/throw_at/proc/ClearThrowable)
...
/datum/build_mode/throw_at/proc/ClearThrowable(feedback)
	...
	unregister_signal(to_throw, SIGNAL_DESTROY, /datum/build_mode/throw_at/proc/ClearThrowable)
	to_throw = null
	if(feedback)

...
/datum/admins/proc/showAccounts(var/targetkey)
	var/size = 0
	var/output = "<meta charset=\"utf-8\"><center><table border='1'> <caption>���������� �� computerID</caption><tr> <th width='100px' >ckey</th><th width='100px'>firstseen</th><th width='100px'>lastseen</th><th width='100px'>ip</th><th width='100px'>computerid </th></tr>"
	...
	output += "<center><table border='1'> <caption>���������� �� IP</caption><tr> <th width='100px' >ckey</th><th width='100px'>firstseen</th><th width='100px'>lastseen</th><th width='100px'>ip</th><th width='100px'>computerid </th></tr>"
...
/datum/admins/proc/checkAllAccounts()
	var/DBQuery/query
	var/t1 = ""
	var/output = "<meta charset=\"utf-8\"><B>���������� �� IP</B><BR><BR>"

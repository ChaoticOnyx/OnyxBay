...
/obj/item/clothing/head/helmet/space/void/mining
	...
	armor_values = alist(melee = 110, bullet = 75, laser = 45, energy = 5, bomb = 55, bio = 100)
...
/obj/item/clothing/head/helmet/space/void/mining/alt
	...
	armor_values = alist(melee = 50, bullet = 15, laser = 20,energy = 5, bomb = 55, bio = 100)
...
/obj/item/clothing/head/helmet/space/void/mining/reinforced
	...
	armor_values = alist(melee = 125, bullet = 80, laser = 65, energy = 15, bomb = 65, bio = 100)

...
/obj/item/clothing/head/helmet/space/void/security
	...
	icon_state = "sec_helm"
	item_state = "sec_helm"
	armor_values = alist(melee = 70, bullet = 100, laser = 70, energy = 5, bomb = 45, bio = 100)
...
/obj/item/clothing/head/helmet/space/void/security/alt
	...
	armor_values = alist(melee = 90, bullet = 90, laser = 80, energy = 25, bomb = 35, bio = 100)
...
/obj/item/clothing/head/helmet/space/void/security/hos
	...
	armor_values = alist(melee = 80, bullet = 120, laser = 90, energy = 35, bomb = 45, bio = 100)

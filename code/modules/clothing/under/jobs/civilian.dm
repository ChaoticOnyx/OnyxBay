...
/obj/item/clothing/under/rank/bartender/dress
	name = "bartender's dress"
	icon_state = "bartender_dress"
...
/obj/item/clothing/under/rank/captain/dress
	name = "captain's jumpdress"
	desc = "It's a blue jumpdress with some gold markings denoting the rank of \"Captain\"."
	icon_state = "captain_dress"
	item_state = "captain_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/rank/qm/dress
	name = "quartermaster's jumpdress"
	desc = "It's a jumpdress worn by the quartermaster. It's specially designed to prevent back injuries caused by pushing paper."
	icon_state = "qm_dress"
	item_state = "qm_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/rank/cargotech/dress
	name = "cargo technician's jumpdress"
	desc = "Dreeeeeeess! They're comfy and easy to wear!"
...
/obj/item/clothing/under/rank/miner/dress //No skirt, just a dress. Skirts will make it uncomfortable to work in the mine.
	name = "shaft miner's jumpdress"
	desc = "It's a snappy jumpdress with a sturdy set of vest. It is very dirty."
	icon_state = "miner_dress"
	item_state = "miner_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/rank/chaplain/dress
	name = "chaplain's jumpdress"
	desc = "It's a black jumpdress, often worn by religious folk."
	icon_state = "chaplain_dress"
	item_state = "chaplain_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/rank/chef/dress
	name = "chef's dress"
	icon_state = "chef_dress"
	item_state = "chef_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/rank/hydroponics/dress
	name = "botanist's jumpdress"
	desc = "It's a jumpdress designed to protect against minor plant-related hazards."
	icon_state = "hydroponics_dress"
	item_state = "hydroponics_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/rank/internalaffairs/dress
	...
	icon_state = "internalaffairs_dress"
	item_state = "internalaffairs_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/rank/janitor/dress
	name = "janitor's jumpdress"
	desc = "It's the official jumpdress of the janitor. It has minor protection from biohazards."
	icon_state = "janitor_dress"
	item_state = "janitor_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
...
/obj/item/clothing/under/lawyer/bluesuit/dress
	name = "Blue Suit Dress"
	desc = "A classy suit dress."
	icon_state = "bluesuit_dress"
	item_state = "bluesuit_dress"
...
/obj/item/clothing/under/librarian/dress
	name = "sensible dress"
	icon_state = "librarian_dress"
	item_state = "librarian_dress"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS

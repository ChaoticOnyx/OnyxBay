...
/obj/item/clothing/suit/storage/hooded/wintercoat/captain
	...
	armor_values = alist(melee = 20, bullet = 15, laser = 20, energy = 10, bomb = 15, bio = 0)

/obj/item/clothing/suit/storage/hooded/wintercoat/security
	name = "security winter coat"
	icon_state = "coatsecurity"
	armor_values = alist(melee = 25, bullet = 20, laser = 20, energy = 15, bomb = 20, bio = 0)
...
/obj/item/clothing/suit/storage/hooded/wintercoat/science
	...
	armor_values = alist(melee = 0, bullet = 0, laser = 0,energy = 0, bomb = 10, bio = 0)
...
/obj/item/clothing/suit/storage/hooded/wintercoat/miner
	...
	armor_values = alist(melee = 10, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0)
...
/obj/item/clothing/suit/storage/hooded/wintercoat/ce
	name = "ce winter coat"
	icon_state = "coatce"
	armor_values = alist(melee = 0, bullet = 0, laser = 0, energy = 10, bomb = 0, bio = 0)
...
/obj/item/clothing/suit/storage/hooded/wintercoat/rd
	name = "rd winter coat"
	icon_state = "coatrd"
	armor_values = alist(melee = 0, bullet = 0, laser = 10, energy = 0, bomb = 10, bio = 0)

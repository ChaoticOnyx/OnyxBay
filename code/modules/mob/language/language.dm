...
/mob/proc/can_speak(datum/language/speaking)
	...
	return (speaking.can_speak_special(src) && (universal_speak || (speaking && speaking.language_flags & INNATE) || (speaking in src.languages) || (speaking in src.speak_only_languages)))

/obj/item/organ_module/active/language
...
/obj/item/organ_module/active/language/post_install(obj/item/organ/E)
	. = ..()
	add_languages(usr)

/obj/item/organ_module/active/language/post_removed(obj/item/organ/E)
	. = ..()
	remove_languages(usr)

/obj/item/organ_module/active/language/organ_installed()
	. = ..()
	add_languages(usr)

/obj/item/organ_module/active/language/organ_removed()
	. = ..()
	remove_languages(usr)

/obj/item/organ_module/active/language/proc/add_languages(mob/living/carbon/human/H)
...
/obj/item/organ_module/active/language/proc/remove_languages(mob/living/carbon/human/H)
	for(var/language in added_languages)
		H.remove_language(language)
	added_languages = list()
	remove_verb(H, granted_verbs)

/obj/item/organ_module/active/language/emp_act()
	. = ..()

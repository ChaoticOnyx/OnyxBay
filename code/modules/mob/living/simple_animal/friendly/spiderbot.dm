/mob/living/simple_animal/spiderbot
	...
	var/obj/item/organ/internal/mastermind/mmi/mmi = null
...
/mob/living/simple_animal/spiderbot/attackby(obj/item/O as obj, mob/user as mob)
	...
	if(istype(O, /obj/item/organ/internal/mastermind/mmi) || istype(O, /obj/item/organ/internal/mastermind/posibrain))
		var/mob/living/carbon/brain/B
		if(istype(O, /obj/item/organ/internal/mastermind/mmi))
			var/obj/item/organ/internal/mastermind/mmi/M = O
			B = M.brainmob
		else
			var/obj/item/organ/internal/mastermind/posibrain/P = O
			B = P.brainmob
		if(src.mmi)
		...
		if(istype(O, /obj/item/organ/internal/mastermind/posibrain))
			positronic = 1
...
/mob/living/simple_animal/spiderbot/proc/transfer_personality(obj/item/organ/internal/mastermind/mmi/M as obj)

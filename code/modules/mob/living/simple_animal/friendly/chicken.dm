...
/mob/living/simple_animal/chicken/attackby(obj/item/O, mob/user)
	if(istype(O, /obj/item/reagent_containers/food/grown)) //feedin' dem chickens
		var/obj/item/reagent_containers/food/grown/G = O
		feed_with(G, user)
	else
		..()

/mob/living/simple_animal/chicken/proc/feed_with(obj/item/reagent_containers/food/grown/G, mob/user)
	if(!G)
...
/datum/chicken_species
	...
	var/maxHealth = 10
	var/meat_type = /obj/item/reagent_containers/food/meat/chicken
...
/datum/chicken_species/robot
	...
	maxHealth = 20
	egg_type = list(/obj/item/reagent_containers/food/egg/robot)
	fertile = FALSE
	mutable = FALSE
...
/datum/chicken_species/golden
	...
	egg_type = list(/obj/item/reagent_containers/food/egg/golden)
	fertile = FALSE
	mutable = FALSE
...
/datum/chicken_species/plasma
	...
	egg_type = list(/obj/item/reagent_containers/food/egg/plasma)
	fertile = FALSE
	mutable = FALSE
...
/datum/chicken_species/vegan
	...
	maxHealth = 20
	egg_type = list(/obj/item/reagent_containers/food/vegg = 17,
					/obj/item/reagent_containers/food/grown/potato = 1,
					/obj/item/reagent_containers/food/grown/tomato = 1,
					/obj/item/reagent_containers/food/grown/carrot = 1)
	fertile = FALSE
	mutable = FALSE
...
/datum/chicken_species/rainbow
	...
	egg_type = list(/obj/item/reagent_containers/food/egg/randomcolor = 3,
					/obj/item/reagent_containers/food/egg/rainbow = 2)
	fertile = FALSE
	mutable = FALSE

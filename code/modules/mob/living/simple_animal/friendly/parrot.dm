...
/mob/living/simple_animal/parrot
	...
	speak = list("œË‚ÂÚ"," ÂÍÂ?","–ﬂﬂﬂﬂ ‘˝‰  ÓÎÎÓÌ Û·Ë‚‡ÂÚ ‚ ÚÂı‡ı")
			...
			switch(remove_from)
				if("ears")
					if(ears)
						if(available_channels.len)
							src.say("[pick(available_channels)] –––ﬂﬂﬂﬂ Œ—“¿¬‹ Õ¿”ÿÕ»  ––ﬂﬂﬂﬂﬂﬂ!")
						else
							src.say("––ﬂﬂﬂﬂﬂ Œ—“¿¬‹ Õ¿”ÿÕ»  –––ﬂﬂﬂﬂﬂ!")
						ears.loc = src.loc
						ears = null
				...
				if("claws")
					if(!held_item)
						...
						return
					if(available_channels.len)
						src.say("[pick(available_channels)] –––ﬂﬂﬂﬂﬂ œŒÀŒ∆» Õ¿ Ã≈—“Œ ––ﬂﬂﬂﬂﬂﬂ!")
					else
						src.say("–––ﬂﬂﬂﬂ œŒÀŒ∆» Õ¿ Ã≈—“Œ –––ﬂﬂﬂﬂﬂﬂ!")
...
/mob/living/simple_animal/parrot/Poly
	...
	speak = list("œÓÎË ıÓ˜ÂÚ ÍÂÍÂ!", ":e œÓ‚Â¸ÚÂ Ï‡ÚÂË˛, Û˘Â·˚!",":e Õ‡ÒÚ‡Ë‚‡ÈÚÂ —Ã≈—˚, ÎÂÌË‚˚Â ÊÓÔ˚!",":e  “Œ —œ»«ƒ»À ◊≈–“Œ¬€ –»√»?",":e ŒÕ¿ —≈…◊¿— ≈¡Õ≈“ ¬€«€¬¿…“≈ ÿ¿““À!")

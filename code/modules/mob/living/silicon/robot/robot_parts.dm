...
/obj/item/robot_parts/robot_suit/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(istype(W, /obj/item/organ/internal/mastermind/mmi) || istype(W, /obj/item/organ/internal/mastermind/posibrain))
		var/mob/living/carbon/brain/B
		if(istype(W, /obj/item/organ/internal/mastermind/mmi))
			var/obj/item/organ/internal/mastermind/mmi/M = W
			B = M.brainmob
		else
			var/obj/item/organ/internal/mastermind/posibrain/P = W
			B = P.brainmob
		if(check_completion())
			if(!istype(loc,/turf))
...
/obj/item/robot_parts/chest/attackby(obj/item/W, mob/user)
	...
	if(istype(W, /obj/item/robot_parts/head))
		...
		if (success)
			...
			var/obj/item/organ/internal/mastermind/brain = H.internal_organs_by_name[BP_BRAIN]
			H.organs -= brain

...
/obj/item/borg/upgrade/archeologist/action(mob/living/silicon/robot/R)
	...
	if(!can_install(src, R))
		...
		R.module.modules += new /obj/item/pickaxe/archeologist/brush(R.module)
		R.module.modules += new /obj/item/pickaxe/archeologist/one_pick(R.module)
		R.module.modules += new /obj/item/pickaxe/archeologist/two_pick(R.module)
		R.module.modules += new /obj/item/pickaxe/archeologist/three_pick(R.module)
		R.module.modules += new /obj/item/pickaxe/archeologist/four_pick(R.module)
		R.module.modules += new /obj/item/pickaxe/archeologist/five_pick(R.module)
		R.module.modules += new /obj/item/pickaxe/archeologist/six_pick(R.module)

...
/obj/item/weapon/robot_module/standard/New()
	...
	src.modules += new /obj/item/weapon/wrench/borg(src)
	src.modules += new /obj/item/weapon/melee/baton/robot(src)
	src.modules += new /obj/item/weapon/extinguisher/borg(src)
	src.modules += new /obj/item/weapon/crowbar/borg(src)
	src.modules += new /obj/item/device/healthanalyzer/borg(src)
	src.modules += new /obj/item/weapon/inflatable_dispenser/robot(src)
	src.modules += new /obj/item/weapon/weldingtool/borg(src)
...
/obj/item/weapon/robot_module/medical/surgeon/New()
	...
	src.modules += new /obj/item/device/flash(src)
	src.modules += new /obj/item/weapon/crowbar/borg(src)
	src.modules += new /obj/item/weapon/extinguisher/borg/mini(src)
	src.modules += new /obj/item/device/healthanalyzer/borg(src)
...
/obj/item/weapon/robot_module/engineering/general/New()
	...
	src.modules += new /obj/item/weapon/extinguisher/borg(src)
	src.modules += new /obj/item/weapon/weldingtool/borg(src)
	src.modules += new /obj/item/weapon/screwdriver/borg(src)
	src.modules += new /obj/item/weapon/wrench/borg(src)
	src.modules += new /obj/item/weapon/crowbar/borg(src)
	src.modules += new /obj/item/weapon/wirecutters/borg(src)
	src.modules += new /obj/item/device/multitool/borg(src)
...
/obj/item/weapon/robot_module/engineering/adv/New()
	...
	src.modules += new /obj/item/device/flash(src)
	src.modules += new /obj/item/weapon/extinguisher/borg(src)
	src.modules += new /obj/item/weapon/weldingtool/borg/adv(src)
	src.modules += new /obj/item/weapon/screwdriver/borg(src)
	src.modules += new /obj/item/weapon/wrench/borg(src)
...
/obj/item/weapon/robot_module/drone/New(mob/living/silicon/robot/robot)
	src.modules += new /obj/item/weapon/weldingtool/borg/drone(src)
	src.modules += new /obj/item/weapon/screwdriver/borg/drone(src)
	src.modules += new /obj/item/weapon/wrench/borg/drone(src)
	src.modules += new /obj/item/weapon/crowbar/borg/drone(src)

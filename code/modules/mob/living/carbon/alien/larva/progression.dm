...
#define DESC_HUNTER_DEGRADED "\n<B>Degraded Hunters</B> <span class='notice'> are weaker and more fragile variant of hunters, able to rapidly move through ventilation shafts. Hunters generate plasma slowly and have low reserves. <B>Monkey genome did not let them to fully develop their potential, so their <I>Tackle</I> ability is replaced with <I>Whip</I></B></span>"

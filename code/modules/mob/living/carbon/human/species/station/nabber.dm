/datum/species/nabber
	...
	has_organ = list(    // which required-organ checks are conducted.
		BP_BRAIN =    /obj/item/organ/internal/cerebrum/brain/nabber,
	...
	/* Bay12-style fix. We don't need it, we cut it.
	equip_adjust = list(
...
/datum/species/nabber/handle_movement_delay_special(mob/living/carbon/human/H)
	...
	if(istype(B,/obj/item/organ/internal/cerebrum/brain/nabber))
		var/obj/item/organ/internal/cerebrum/brain/nabber/N = B

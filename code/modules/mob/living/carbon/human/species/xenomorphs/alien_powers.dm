...
/mob/living/carbon/human/proc/check_alien_ability(cost, needs_organ = null, needs_foundation = FALSE) //Returns 1 if the ability is clear for usage.
...
/mob/living/carbon/human/proc/Spit(mob/target as mob in oview())
	...
	if(spitting && incapacitated(INCAPACITATION_DISABLED))
		...
		if(!check_alien_ability(20, BP_ACID))
			spitting = 0
			return
...
/mob/living/carbon/human/proc/neurotoxin()
	...
	if(spitting)
		to_chat(src, "<span class='alium'>I stop preparing to spit.</span>")
		spitting = 0
		return
	...
	if(!check_alien_ability(40, BP_ACID))
		...
		to_chat(src, "<span class='alium'>I prepare to spit neurotoxin.</span>")
...
/mob/living/carbon/human/proc/acidspit()
	...
	if(!check_alien_ability(50, BP_ACID))
		...
		spit_name = "acid"
		to_chat(src, "<span class='alium'>I prepare to spit acid.</span>")

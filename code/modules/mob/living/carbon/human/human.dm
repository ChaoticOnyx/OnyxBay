...
/mob/living/carbon/human/revive(ignore_prosthetic_prefs = FALSE)
	if(should_have_organ(BP_HEART))
		vessel.add_reagent(/datum/reagent/bloodbase/blood, species.blood_volume - vessel.total_volume)
		fixblood()
...
/mob/living/carbon/human/set_species(new_species, default_colour)
	...
	spawn(0)
		...
		if(vessel.total_volume < species.blood_volume)
			...
			vessel.remove_reagent(/datum/reagent/bloodbase/blood, vessel.total_volume - species.blood_volume)
			vessel.maximum_volume = species.blood_volume
		fixblood()

...
/proc/check_trajectory(atom/movable/target, atom/movable/firer, pass_flags=PASS_FLAG_TABLE|PASS_FLAG_GLASS|PASS_FLAG_GRILLE, item_flags = null, obj_flags = null)

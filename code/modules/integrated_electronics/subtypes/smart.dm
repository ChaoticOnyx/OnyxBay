...
/obj/item/integrated_circuit/input/mmi_tank
	...
	var/obj/item/organ/internal/mastermind/mmi/installed_brain

/obj/item/integrated_circuit/input/mmi_tank/ask_for_input(mob/user)
	attack_self(user)

/obj/item/integrated_circuit/input/mmi_tank/attackby(obj/item/organ/internal/mastermind/mmi/O, mob/user)
...
/mob/living/carbon/brain/ClickOn(atom/A, params)
	...
	if(istype(loc, /obj/item/organ/internal/mastermind/mmi))
		var/obj/item/organ/internal/mastermind/mmi/H = loc

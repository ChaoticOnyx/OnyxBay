...
/datum/cooking/recipe_step/use_item/New(item_type, datum/cooking/recipe/our_recipe)
	#ifdef CWJ_DEBUG
	if(!ispath(item_type))
...
/datum/cooking/recipe_step/use_item/check_conditions_met(obj/added_item, datum/cooking/recipe_tracker/tracker)
	if(src.exact_path)
...
/datum/cooking/recipe_step/use_item/calculate_quality(obj/added_item)

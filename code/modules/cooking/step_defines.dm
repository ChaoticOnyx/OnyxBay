...
/datum/cooking/recipe_step/New(datum/cooking/recipe/our_recipe)
...
/datum/cooking/recipe_step/proc/calculate_quality(obj/added_item, obj/item/reagent_containers/vessel/cooking_container/container)
	return 0
...
/datum/cooking/recipe_step/proc/in_option_chain(datum/cooking/recipe_step/step)
	if(!step)
		return FALSE
...
/datum/cooking/recipe_step/proc/get_step_result_text(obj/used_obj, step_quality)
	if(custom_result_desc)
		return custom_result_desc
	else
		return "skip"

/datum/cooking/recipe_step/proc/follow_step(obj/added_item, obj/item/reagent_containers/vessel/cooking_container/container)
	return CWJ_SUCCESS

...
/datum/shuttle/autodock/multi/antag/train
	...
	shuttle_area = /area/train/station
	dock_target = "train_dock"
	current_location = "nav_train_station"
	home_waypoint = "nav_train_station"
	landmark_transition = "nav_train_transition"
	announcer = "Kraken Complex Announcment System"
	arrival_message = "Now departing from: Sector B"
	move_time = 120
	sound_takeoff = 'sound/effects/train_horn.ogg'

/obj/effect/shuttle_landmark/traine/station
	name = "Sector B: Office Complex"
	landmark_tag = "nav_train_station"
	base_area = /area/train/station
	base_turf = /turf/simulated/floor/plating

/obj/effect/shuttle_landmark/traine/internim
	name = "In transit"
	landmark_tag = "nav_train_transition"
	autoset = 1
	base_turf = /turf/unsimulated/train/dust

/obj/effect/shuttle_landmark/traine/landed
	name = "Sector C: Archeology Hub"
	landmark_tag = "nav_train_science"
	autoset = 1
...
/datum/shuttle/autodock/multi/antag/dropship
	...
	warmup_time = 15
	destination_tags = list(
		"nav_dropship_station",
		"nav_dropship_landed"
		)
	shuttle_area = /area/dropship/station
	dock_target = "dropship_dock"
	current_location = "nav_dropship_station"
	home_waypoint = "nav_dropship_station"
	landmark_transition = "nav_dropship_transition"
	announcer = "NSB Procyon-12"
	move_time = 60
	arrival_message = "Attention. There appeares to be some sort of interferience in the planets atmosphere close to your location. Be carefull."

/obj/effect/shuttle_landmark/dropship/station
	name = "Dropship Shuttle"
	landmark_tag = "nav_dropship_station"
	base_area = /area/space
	base_turf = /turf/simulated/floor/plating/rough

/obj/effect/shuttle_landmark/dropship/internim
	name = "In transit"
	landmark_tag = "nav_dropship_transition"
	autoset = 1

/obj/effect/shuttle_landmark/dropship/landed
	name = "Dropship landed"
	landmark_tag = "nav_dropship_landed"
	autoset = 1
...
/datum/shuttle/autodock/multi/antag/pick_up
	...
	shuttle_area = /area/pickup/remote
	dock_target = "pickup_dock"
	current_location = "nav_pickup_remote"
	home_waypoint = "nav_pickup_remote"
	move_time = 0

/obj/effect/shuttle_landmark/pickup/station
	name = "Pickup Shuttle"
	landmark_tag = "nav_pickup_remote"
	base_area = /area/space
	base_turf = /turf/simulated/floor/plating/rough

/obj/effect/shuttle_landmark/pickup/landed
	name = "Pickup Jungle"
	landmark_tag = "nav_pickup_fort"
	autoset = 1
	base_area = /area/event/exterior

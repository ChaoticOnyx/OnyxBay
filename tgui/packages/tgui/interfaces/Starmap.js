...
export const drawStarmap = (props, context, starCallback) => {
  ...
  const scale_factor = typeof (data.scale_factor !== "undefined")
    ? data.scale_factor
    : 12;
  let arrowStyle =
    "position: absolute; left: " + data.freepointer_x * 12 + "px;";
  ...
  arrowStyle +=
    "M12=" + -data.freepointer_sin + ",M21=" + data.freepointer_sin + ",";
  ...
  arrowStyle +=
    "M21=" + data.freepointer_sin + ", M22=" + data.freepointer_cos + ");";
  arrowStyle += "-ms-transform: matrix(" + data.freepointer_cos + ",";
  arrowStyle += "" + -data.freepointer_sin + ",";
  arrowStyle +=
    "" + data.freepointer_sin + "," + data.freepointer_cos + ", 0, 0);";
  ...
  const drawSystemNodes = (System) => {
    ...
    {
      (!!is_current && (borderType = "1px solid #193a7a")) ||
  ...
  const drawLines = (Line) => {
    ...
    return <div style={lineStyle} class="line" />;
  };

  let SystemNodes = data.star_systems
...
export const Starmap = (props, context) => {
  ...
  return (
    <Window resizable theme="ntos" width={800} height={695}>
              ...
              {(!!data.in_transit && (
                ...
                <Section title="Current system:">
                  <Button
                    ...
                    tooltip="Click to view information about star"
                    icon="star"
                    onClick={() => act("star_id", { star_id: data.star_id })}
                  />
                </Section>
              )}
            </>

...
export const FighterControls = (props, context) => {
  ...
  const [settingsVisible, setSettingsVisible] = useLocalState(
    context,
    "settings",
    false
  );
  return (
    <Window resizable theme="hackerman" width={490} height={400}>
      <Window.Content>
        ...
        {!!data.ftl_capable && (
          <Section title="FTL Drive:">
            ...
            <ProgressBar
              value={
                (data.ftl_spool_progress / data.ftl_spool_time) * 100 * 0.01
              }
              ranges={{
                good: [0.9, Infinity],
                average: [0.15, 0.9],
        ...
        >
          ...
          <Button
            ...
            color={
              (data.docking_cooldown && "orange") ||
              (data.docking_mode ? "good" : null)
            }
        ...
        {!!settingsVisible && (
          <Section title="Settings:">
            <Button content={"Set Name"} onClick={() => act("set_name")} />
            <Button
              content={"Maintenance"}
                    ...
                    return (
                      <LabeledList.Item key={key} label={`${value.name}`}>
                        <Button
                          ...
                          icon="eject"
                          onClick={() =>
                            act("eject_hardpoint", { id: value.id })
                          }
                        />
                        <Button
                          ...
                          icon="download"
                          onClick={() =>
                            act("dump_hardpoint", { id: value.id })
                          }
                        />
                      </LabeledList.Item>
                    );

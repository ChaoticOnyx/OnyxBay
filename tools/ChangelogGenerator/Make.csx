...
WriteLine($"╰  Обработано {changelogs.Count} чейнджлогов.");
WriteLine("╭  Проверка чейнджлогов и кэша.");
...
WriteLine($"╰  Ошибок не найдено.");

WriteLine($"╭  Парсинг шаблона из {Settings.ChangelogTemplate.Name}.");
